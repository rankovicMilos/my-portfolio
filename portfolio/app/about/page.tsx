  ...
  return (
    ...
    >
      <div className="relative">
        {/* Profile Image - Desktop - Positioned at top right */}
        {aboutMePage?.profileImage && (
          <div className="hidden md:block absolute -top-32 right-15 w-48 h-48 overflow-hidden rounded-full border-4 border-white/10">
            <Image
              src={urlFor(aboutMePage.profileImage).url()}
              alt={aboutMePage.title || "Profile"}
              fill
        ...
        {aboutMePage?.profileImage && (
          <div className="md:hidden relative w-48 h-48 mx-auto mb-8 overflow-hidden rounded-full border-4 border-white/10">
            <Image
              src={urlFor(aboutMePage.profileImage).url()}
              alt={aboutMePage.title || "Profile"}
              fill
